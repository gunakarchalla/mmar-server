...
class Instance_classesController {
     ...
     * @method
     */
    get_class_instance_by_uuid: RequestHandler = withTransaction(async (client, req) => {
     ...
     * @method
     */
    get_classes_instances_for_scene: RequestHandler = withTransaction(async (client, req) => {
     ...
     * @method
     */
    patch_class_instance_by_uuid: RequestHandler = withTransaction(async (client, req) => {
     ...
     * @method
     */
    post_class_instance_for_scene: RequestHandler = withTransaction(async (client, req) => {
        const newClass = ClassInstance.fromJS(req.body) as ClassInstance;
     ...
     * @method
     */
    post_class_instance_by_uuid: RequestHandler = withTransaction(async (client, req) => {
        const newClass = ClassInstance.fromJS(req.body) as ClassInstance;
     ...
     * @method
     */
    delete_class_instance_for_scene: RequestHandler = withTransaction(async (client, req) => {
     ...
     * @method
     */
    delete_class_instance_by_uuid: RequestHandler = withTransaction(async (client, req) => {
